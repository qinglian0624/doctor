/*
 ...
 Source Server         : 医疗课件录制
 Source Server Type    : MySQL
 Source Server Version : 50740
 Source Host           : 123.249.101.88:3306
 Source Schema         : 123_249_101_38

 Target Server Type    : MySQL
 Target Server Version : 50740
 File Encoding         : 65001

 Date: 20/07/2023 11:22:03
*/
...
) ENGINE = InnoDB AUTO_INCREMENT = 388 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '管理员日志表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `fa_attachment`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '附件表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 123 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '节点表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `fa_card`  (
  ...
  `state` int(4) NOT NULL DEFAULT 0 COMMENT '认证状态',
  `uid` int(11) NULL DEFAULT NULL COMMENT '角色id',
  `idcard` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '身份证照片',
  `titlecard` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '职称照片',
  `createtime` bigint(20) NULL DEFAULT NULL COMMENT '创建时间',
  `project_id` int(11) NULL DEFAULT NULL COMMENT '医疗项目',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `uid`(`uid`) USING BTREE,
  INDEX `state`(`state`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 42 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '项目认证' ROW_FORMAT = Dynamic;
...
CREATE TABLE `fa_category`  (
  ...
  INDEX `pid`(`pid`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 51 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '分类表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `fa_command`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 28 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '在线命令表' ROW_FORMAT = Dynamic;
...
-- ----------------------------
-- Table structure for fa_courseware
-- ----------------------------
DROP TABLE IF EXISTS `fa_courseware`;
CREATE TABLE `fa_courseware`  (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `edu_type` int(4) NULL DEFAULT NULL COMMENT '教育类型',
  `edu_dire` int(4) NULL DEFAULT NULL COMMENT '教育方向',
  `edu_area` int(4) NULL DEFAULT NULL COMMENT '教育领域',
  `cours_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '文档名称',
  `cours_video` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '视频',
  `cours_files` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT 'PPT课件',
  `uid` int(11) NULL DEFAULT NULL COMMENT '医师id',
  `createtime` bigint(20) NULL DEFAULT NULL COMMENT '创建时间',
  `video_status` int(4) NULL DEFAULT NULL COMMENT '视频审核状态',
  `project_id` int(11) NULL DEFAULT NULL COMMENT '项目id',
  `sign_img` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '签名',
  `ppt_status` int(4) NULL DEFAULT NULL COMMENT 'ppt审核状态',
  `video_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '视频名称',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `uid`(`uid`) USING BTREE,
  INDEX `createtime`(`createtime`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 27 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '课件表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `fa_files`  (
  ...
  `couse_id` int(11) NULL DEFAULT NULL COMMENT '课件id',
  `createtime` bigint(20) NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `couse_id`(`couse_id`) USING BTREE,
  INDEX `id`(`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 47 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '文档表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for fa_patient
-- ----------------------------
DROP TABLE IF EXISTS `fa_patient`;
CREATE TABLE `fa_patient`  (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '患者姓名',
...
-- ----------------------------
-- Table structure for fa_project
-- ----------------------------
...
CREATE TABLE `fa_project`  (
  ...
  `image` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '项目标识',
  `files` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '项目协议',
  `createtime` bigint(20) NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '医疗项目' ROW_FORMAT = Dynamic;
...
CREATE TABLE `fa_user`  (
  ...
  `hospital` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '医院',
  `title` int(4) NULL DEFAULT NULL COMMENT '职称',
  `detail` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '详细科室',
  `age` int(11) NULL DEFAULT NULL COMMENT '年龄',
...
) ENGINE = InnoDB AUTO_INCREMENT = 80 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '会员表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for fa_user_authen
-- ----------------------------
DROP TABLE IF EXISTS `fa_user_authen`;
CREATE TABLE `fa_user_authen`  (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `uid` int(11) NULL DEFAULT NULL COMMENT '角色id',
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '姓名',
  `card_id` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '身份证号',
  `idcard_head` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '人面像',
  `idcard_back` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '国徽面',
  `bankid` char(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '银行卡号',
  `createtime` bigint(20) NULL DEFAULT NULL COMMENT '创建时间',
  `state` int(4) NOT NULL DEFAULT 0 COMMENT '认证状态',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `uid`(`uid`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 50 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '实名认证' ROW_FORMAT = Dynamic;
...
CREATE TABLE `fa_video`  (
  ...
  INDEX `couse_id`(`couse_id`) USING BTREE,
  INDEX `id`(`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 45 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '课件视频表' ROW_FORMAT = Dynamic;
